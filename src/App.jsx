            ...
            <div className="max-w-6xl mx-auto">
              <div className="glass-card p-2 shadow-2xl overflow-hidden">
                <img 
                  ...
                  onError={(e) => { e.target.src = "https://via.placeholder.com/1200x500/1e293b/60a5fa?text=Image+Terrain"; }}
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="glass-card overflow-hidden group hover:border-blue-400/50 transition-all duration-500">
                <div className="aspect-video w-full overflow-hidden bg-black/20">
                  <img src="/cessna172.jpg" alt="Cessna 172" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-90" onError={(e) => e.target.src = "https://via.placeholder.com/600x400?text=Cessna"} />
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-xs leading-relaxed opacity-60">Un avion de début stable et précis, idéal pour les sessions d'apprentissage.</p>
                </div>
              </div>

              <div className="glass-card overflow-hidden group hover:border-blue-400/50 transition-all duration-500">
                <div className="aspect-video w-full overflow-hidden bg-black/20">
                  <img src="/extra330.jpg" alt="Extra 330" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-90" onError={(e) => e.target.src = "https://via.placeholder.com/600x400?text=Extra"} />
                </div>
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="text-xs leading-relaxed opacity-60">Un avion de voltige performant et précis pour pilotes confirmés.</p>
                </div>
              </div>

              <div className="glass-card overflow-hidden group hover:border-blue-400/50 transition-all duration-500">
                <div className="aspect-video w-full overflow-hidden bg-black/20">
                  <img src="/corsair2.jpg" alt="Corsair F4-U" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-90" onError={(e) => e.target.src = "https://via.placeholder.com/600x400?text=Corsair"} />
                </div>
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="text-xs leading-relaxed opacity-60">Un Warbird légendaire nécessitant une certaine expérience de pilotage.</p>
                </div>
              </div>
            ...
            <div className="max-w-5xl mx-auto space-y-6">
              ...
              <div className="glass-card p-6 flex flex-col md:flex-row items-center gap-6 hover:border-blue-400/30 transition-colors">
                ...
                <div className="flex-grow text-center md:text-left space-y-2">
                  ...
                  <p className="text-sm opacity-70 text-blue-50">Vols de découverte, démonstrations et convivialité.</p>
                </div>
                <div className="flex-shrink-0 w-24 h-24 group/img">
                  <a href="/image.png" target="_blank" rel="noopener noreferrer" className="block w-full h-full relative">
                    <img src="/image.png" alt="Affiche" className="w-full h-full object-cover rounded-xl border border-white/10 group-hover/img:border-blue-400/50 transition-all" onError={(e) => e.target.src="https://via.placeholder.com/100?text=Affiche"} />
