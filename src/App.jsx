              ...
              <div className="glass-card overflow-hidden group hover:border-blue-400/50 transition-all duration-500">
                ...
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-1 rounded border border-blue-500/30 uppercase">Electrique</span>
                  </div>
              ...
              <div className="glass-card overflow-hidden group hover:border-blue-400/50 transition-all duration-500">
                ...
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-1 rounded border border-blue-500/30 uppercase">Thermique</span>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm border-t border-white/5 pt-4 opacity-80">
              ...
              <div className="space-y-6">
                <div className="glass-card p-8 border-t-2 border-green-500/30 space-y-6 h-full">
                  ...
                  <div className="space-y-4">
                    <a href="/formulaire-inscription.pdf" target="_blank" className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-green-500/10 hover:border-green-500/30 transition-all group">
                    ...
                    <a href="/reglement-interieur.pdf" target="_blank" className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-green-500/10 hover:border-green-500/30 transition-all group">
                      <div className="flex items-center gap-4">
