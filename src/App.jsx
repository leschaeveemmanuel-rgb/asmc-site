        ...
        {page === 'contact' && (
          <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {/* 2. CARTE INTERACTIVE ET ITINÉRAIRE */}
              <div className="space-y-6">
                <div className="glass-card p-8 h-full border-t-2 border-green-500/30 flex flex-col">
                  ...
                  <div className="w-full aspect-square md:aspect-video rounded-xl overflow-hidden border border-white/10 shadow-2xl relative group">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2639.421453268886!2d1.6003113156643247!3d48.544000000000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDjCsDMyJzM4LjQiTiAxwrAzNicwMS4xIkU!5e0!3m2!1sfr!2sfr!4v1707480000000!5m2!1sfr!2sfr&z=14" 
                      width="100%" 
                      height="100%" 
                      style={{ border: 0 }} 
                      allowFullScreen="" 
                  ...
                  <div className="mt-6">
                    <a 
                      href="https://www.google.com/maps/dir/?api=1&destination=48.544000,1.602500" 
                      target="_blank" 
                      rel="noopener noreferrer"
